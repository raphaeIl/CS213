...
public class ChicagoPizza implements PizzaFactory {
    ...
    public Pizza createDeluxe() {
        ...
        return new Deluxe(Size.SMALL, Crust.Deep_Dish, toppings, Style.Chicago, Flavor.Deluxe);
    }
    ...
    public Pizza createMeatzza() {
        ...
        return new Meatzza(Size.SMALL, Crust.Stuffed, toppings, Style.Chicago, Flavor.Meatzza);
    }
    ...
    public Pizza createBBQChicken() {
        ...
        return new BBQChicken(Size.SMALL, Crust.Pan, toppings, Style.Chicago, Flavor.BBQ_Chicken);
    }
    ...
    public Pizza createBuildYourOwn() {
        ...
        return new BuildYourOwn(Size.SMALL, Crust.Pan, toppings, Style.Chicago, Flavor.Build_Your_Own);
    }
}